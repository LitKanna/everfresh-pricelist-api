// ============================================
// EVERFRESH - PRICELIST IMAGE SERVER
// Express server with node-canvas
// Deploy to Render.com / Railway.app
// ============================================
...
app.get('/', (req, res) => {
  res.json({ status: 'ok', service: 'Everfresh Pricelist API' });
});

// Generate pricelist image endpoint
